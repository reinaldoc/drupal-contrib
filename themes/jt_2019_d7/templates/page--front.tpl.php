...
<div id="header_wrapper">
  ...
  <div id="inner_header_wrapper">
    ...
    <header id="header" role="banner">
      ...
      <div class="top_left">
        <?php if ($logo): ?>
          <div id="logo"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><img src="<?php print $logo; ?>" alt="Tribunal Regional do Trabalho da 8ª Região - Pará e Amapá" /></a></div>
        <?php endif; ?>
        <?php if ($site_slogan): ?>
          <h1 id="site-title">
      ...
      <p style="float: left; color: white; font-size: 21px; position: absolute; top: 37px; left: 47%; background-color: red; padding: 3px; opacity: 0.65; border-radius: 4px;">DESENVOLVIMENTO</p>

      <div class="top_right">
          <?php if (theme_get_setting('social_links', 'jt_2019_d7')): ?>
            <div class="social_icons">
            <ul>
              <li class="social_icon icons_rss"   ><a  title="RSS das notícias do TRT8" href="<?php print $front_page; ?>rss.xml" target="_blank" rel="me"></a></li>
              <li class="social_icon icons_youtube"   ><a title="Youtube do TRT8" href="<?php echo theme_get_setting('youtube_profile_url', 'jt_2019_d7'); ?>" target="_blank" rel="me"></a></li>
              <li class="social_icon icons_flickr"   ><a title="Flickr do TRT8" href="<?php echo theme_get_setting('flickr_profile_url', 'jt_2019_d7'); ?>" target="_blank" rel="me"></a></li>
              <li class="social_icon icons_facebook"   ><a title="Facebook do TRT8" href="<?php echo theme_get_setting('facebook_profile_url', 'jt_2019_d7'); ?>" target="_blank" rel="me"></a></li>
              <li  class="social_icon icons_twitter" ><a title="Twitter do TRT8" href="<?php echo theme_get_setting('twitter_profile_url', 'jt_2019_d7'); ?>" target="_blank" rel="me"></a></li>
              <li class="social_icon icons_instagram" ><a title="Instagram do TRT8" href="<?php echo theme_get_setting('instagram_profile_url', 'jt_2019_d7'); ?>" target="_blank" rel="me"></a></li>
            </ul>
